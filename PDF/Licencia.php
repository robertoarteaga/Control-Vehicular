...
$pdf = new FPDF();
	...
	$pdf->image('usuario.png',70,20,30);
	  ...
	  $SQL2 = "SELECT * FROM conductores WHERE RFC=1 ";
	...
	for ($J = 0;$J<mysqli_num_rows($Query2);$J++)
	{
	  $Fila2= mysqli_fetch_row($Query2); 
		...
		for ($I = 0;$I<mysqli_num_rows($Query);$I++)
		{
			...
			$pdf->image('queretaro.png',80,120,15);
//####################### Page 2


			$pdf->AddPage('P', array(105,148));
			$pdf->image('911.png',5,5,13);
			$pdf->image('numero.png',30,5,40);
			$pdf->image('089.png',85,5,15);
			...
			$pdf->image('queretaro.png',10,130,10);
			$pdf->image('sc.png',70,130,20);
